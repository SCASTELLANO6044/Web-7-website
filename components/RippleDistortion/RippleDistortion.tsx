...
const RippleDistortion = ({
    ...
    useEffect(() => {
        ...
        uniforms.wave.uRings.value =
            rings;

        uniforms.composite.uStrength.value =
            strength;

        uniforms.composite.uSwirl.value =
            swirl;

        uniforms.composite.uDispersion.value =
            dispersion;

        uniforms.composite.uGlint.value =
            glint;

        uniforms.composite.uTintAmount.value =
            tintAmount;

        uniforms.composite.uGrayscale.value =
            grayscale ? 1 : 0;

        uniforms.composite.uHighlight.value =
            hexToRGB(highlightColor);

        uniforms.composite.uTint.value =
            hexToRGB(tint);
